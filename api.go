...
func init() {
	...
	assertSizesMatch("GrFlushInfo", C.sizeof_sk_GrFlushInfo, int(C.sk_sizeof_sk_GrFlushInfo))
	assertSizesMatch("GrRecordingContext", C.sizeof_sk_GrRecordingContext, int(C.sk_sizeof_sk_GrRecordingContext))
	assertSizesMatch("GrGLInterface", C.sizeof_sk_GrGLInterface, int(C.sk_sizeof_sk_GrGLInterface))
	assertSizesMatch("GrContextOptions", C.sizeof_sk_GrContextOptions, int(C.sk_sizeof_sk_GrContextOptions))
	assertSizesMatch("Arc", C.sizeof_sk_SkArc, int(C.sk_sizeof_sk_SkArc))
	assertSizesMatch("Bitmap", C.sizeof_sk_SkBitmap, int(C.sk_sizeof_sk_SkBitmap))
	assertSizesMatch("Canvas", C.sizeof_sk_SkCanvas, int(C.sk_sizeof_sk_SkCanvas))
	assertSizesMatch("ColorInfo", C.sizeof_sk_SkColorInfo, int(C.sk_sizeof_sk_SkColorInfo))
	assertSizesMatch("ColorSpace", C.sizeof_sk_SkColorSpace, int(C.sk_sizeof_sk_SkColorSpace))
	assertSizesMatch("Data", C.sizeof_sk_SkData, int(C.sk_sizeof_sk_SkData))
	assertSizesMatch("Font", C.sizeof_sk_SkFont, int(C.sk_sizeof_sk_SkFont))
	assertSizesMatch("FontArguments", C.sizeof_sk_SkFontArguments, int(C.sk_sizeof_sk_SkFontArguments))
	assertSizesMatch("FontArgumentsVariationPosition", C.sizeof_sk_SkFontArgumentsVariationPosition, int(C.sk_sizeof_sk_SkFontArgumentsVariationPosition))
	assertSizesMatch("FontArgumentsPalette", C.sizeof_sk_SkFontArgumentsPalette, int(C.sk_sizeof_sk_SkFontArgumentsPalette))
	assertSizesMatch("FontMetrics", C.sizeof_sk_SkFontMetrics, int(C.sk_sizeof_sk_SkFontMetrics))
	assertSizesMatch("FontMgr", C.sizeof_sk_SkFontMgr, int(C.sk_sizeof_sk_SkFontMgr))
	assertSizesMatch("FontStyle", C.sizeof_sk_SkFontStyle, int(C.sk_sizeof_sk_SkFontStyle))
	assertSizesMatch("FontStyleSet", C.sizeof_sk_SkFontStyleSet, int(C.sk_sizeof_sk_SkFontStyleSet))
	assertSizesMatch("Image", C.sizeof_sk_SkImage, int(C.sk_sizeof_sk_SkImage))
	assertSizesMatch("ImageInfo", C.sizeof_sk_SkImageInfo, int(C.sk_sizeof_sk_SkImageInfo))
	assertSizesMatch("M44", C.sizeof_sk_SkM44, int(C.sk_sizeof_sk_SkM44))
	assertSizesMatch("MemoryStream", C.sizeof_sk_SkMemoryStream, int(C.sk_sizeof_sk_SkMemoryStream))
	assertSizesMatch("IPoint", C.sizeof_sk_SkIPoint, int(C.sk_sizeof_sk_SkIPoint))
	assertSizesMatch("IRect", C.sizeof_sk_SkIRect, int(C.sk_sizeof_sk_SkIRect))
	assertSizesMatch("ISize", C.sizeof_sk_SkISize, int(C.sk_sizeof_sk_SkISize))
	assertSizesMatch("Matrix", C.sizeof_sk_SkMatrix, int(C.sk_sizeof_sk_SkMatrix))
	assertSizesMatch("OpBuilder", C.sizeof_sk_SkOpBuilder, int(C.sk_sizeof_sk_SkOpBuilder))
	assertSizesMatch("Paint", C.sizeof_sk_SkPaint, int(C.sk_sizeof_sk_SkPaint))
	assertSizesMatch("Path", C.sizeof_sk_SkPath, int(C.sk_sizeof_sk_SkPath))
	assertSizesMatch("Point", C.sizeof_sk_SkPoint, int(C.sk_sizeof_sk_SkPoint))
	assertSizesMatch("Pixmap", C.sizeof_sk_SkPixmap, int(C.sk_sizeof_sk_SkPixmap))
	assertSizesMatch("Rect", C.sizeof_sk_SkRect, int(C.sk_sizeof_sk_SkRect))
	assertSizesMatch("RRect", C.sizeof_sk_SkRRect, int(C.sk_sizeof_sk_SkRRect))
	assertSizesMatch("Region", C.sizeof_sk_SkRegion, int(C.sk_sizeof_sk_SkRegion))
	assertSizesMatch("RGBA4f", C.sizeof_sk_SkRGBA4f, int(C.sk_sizeof_sk_SkRGBA4f))
	assertSizesMatch("SamplingOptions", C.sizeof_sk_SkSamplingOptions, int(C.sk_sizeof_sk_SkSamplingOptions))
	assertSizesMatch("Size", C.sizeof_sk_SkSize, int(C.sk_sizeof_sk_SkSize))
	assertSizesMatch("Stream", C.sizeof_sk_SkStream, int(C.sk_sizeof_sk_SkStream))
	assertSizesMatch("String", C.sizeof_sk_SkString, int(C.sk_sizeof_sk_SkString))
	assertSizesMatch("Surface", C.sizeof_sk_SkSurface, int(C.sk_sizeof_sk_SkSurface))
	assertSizesMatch("SurfaceProps", C.sizeof_sk_SkSurfaceProps, int(C.sk_sizeof_sk_SkSurfaceProps))
	assertSizesMatch("SVGDOM", C.sizeof_sk_SkSVGDOM, int(C.sk_sizeof_sk_SkSVGDOM))
	assertSizesMatch("SVGDOMBuilder", C.sizeof_sk_SkSVGDOMBuilder, int(C.sk_sizeof_sk_SkSVGDOMBuilder))
	assertSizesMatch("SVGSVG", C.sizeof_sk_SkSVGSVG, int(C.sk_sizeof_sk_SkSVGSVG))
	assertSizesMatch("SVGLengthContext", C.sizeof_sk_SkSVGLengthContext, int(C.sk_sizeof_sk_SkSVGLengthContext))
	assertSizesMatch("TextBlob", C.sizeof_sk_SkTextBlob, int(C.sk_sizeof_sk_SkTextBlob))
	assertSizesMatch("TextBlobBuilder", C.sizeof_sk_SkTextBlobBuilder, int(C.sk_sizeof_sk_SkTextBlobBuilder))
	assertSizesMatch("TextBlobBuilderRunBuffer", C.sizeof_sk_SkTextBlobBuilderRunBuffer, int(C.sk_sizeof_sk_SkTextBlobBuilderRunBuffer))
	assertSizesMatch("Typeface", C.sizeof_sk_SkTypeface, int(C.sk_sizeof_sk_SkTypeface))
}
