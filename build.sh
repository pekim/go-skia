...
# Update libraries
if grep -q -v $SKIA_TAG "lib/tag.txt"; then
  wget \
    -qO- \
    "https://github.com/rust-skia/skia-binaries/releases/download/$SKIA_TAG/skia-binaries-$SKIA_BINARIES_COMMITHASH-x86_64-unknown-linux-gnu-gl-svg-textlayout-x11.tar.gz" | \
    tar xvz
  rm lib/*
